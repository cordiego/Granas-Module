...
=========================================================
Streamlit dashboard for the 2.1m × 3.4m Granas module.
...
# ─── Page Config ─────────────────────────────────────────────
st.set_page_config(
    page_title="Granas Module | 2.1m × 3.4m",
    page_icon="📐",
    layout="wide",
...
<div class="module-header">
    ...
    100 Sub-cells &bull; CFRP Skeleton &bull; Green Reflectance Cooling</p>
</div>
""", unsafe_allow_html=True)
